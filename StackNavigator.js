...
import SunMercyrTrackerHomeScP from './src/screens/SunMercyrTrackerHomeScP';
import {NavigationContainer} from '@react-navigation/native';
import {GestureHandlerRootView} from 'react-native-gesture-handler';
import {UserProvider, UserContext} from './src/context/UserContext';
import {Provider} from 'react-redux';
import store from './src/redux/store';
import SunMercyrTrackerLoading from './src/screens/SunMercyrTrackerLoading';
import SunMercyrTrackerLoadingFirst from './src/screens/SunMercyrTrackerLoadingFirst';
import SunMercyrTrackerProdScr from './src/screens/SunMercyrTrackerProdScr';
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://wondrous-honored-ecstatic.space/`;
  const URL_IDENTIFAIRE = `M3SaGPjF`;
  ...
  OneSignal.initialize('26a8eef5-2a90-4609-9cba-fe28cad4424f');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-06T07:07:00'); //дата з якої поч працювати webView
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="SunMercyrTrackerProdScr"
            component={SunMercyrTrackerProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'SunMercyrTrackerHomeScP'}>
        <Stack.Screen
          name="SunMercyrTrackerHomeScP"
          component={SunMercyrTrackerHomeScP}
          options={{headerShown: false}}
        />
      </Stack.Navigator>
    );
  ...
  return (
    <NavigationContainer>
      {!louderPrevIsEnded ? (
        <Stack.Navigator initialRouteName={'SunMercyrTrackerLoadingFirst'}>
          <Stack.Screen
            name="SunMercyrTrackerLoadingFirst"
            component={SunMercyrTrackerLoadingFirst}
            options={{headerShown: false}}
          />
        </Stack.Navigator>
      ) : (
...
export default SunMercyrTrackerStack;
